...
[ApiMember(Name = "NewAddressName", Description = "New address name", ParameterType = "body", DataType = "string", IsRequired = false)]
public System.String NewAddressName {get; set; } 
[ApiMember(Name = "AutoReceiveCurrency", Description = "Auto convert to fiat currency on deposit", ParameterType = "body", DataType = "string", IsRequired = false)]
